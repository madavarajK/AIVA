...
def greet():
    ...
    conn.commit()
    conn.close()
    SR.speak("\nMyself aiva. How may I help you?")
    ...
    try:
        while(True):
            ...
            #asking for name
                ...
                SR.speak("My name is aiva and I'm here to serve you.")
            #Full form
            elif there_exists(["what is your full form"," your full form","tell me your full form"],query):
                SR.speak("My name is aiva and full form of aiva is Artificial intelligence virtual assistant.")    
            #How are you
            ...
            #playing on youtube
                ...
                SR.speak("Opening youtube")
                webbrowser.get("chrome",webbrowser.open_new_tab('https://www.youtube.com/'))
                break
            elif there_exists(['open google and search','google and search'],query):
                url='https://google.com/search?q='+query[query.find('for')+4:]
                webbrowser.get("chrome",webbrowser.open_new_tab(url))
                break
            #image search
                ...
                webbrowser.get("chrome",webbrowser.open_new_tab('https://www.google.com'))
                break
                ...
                break
            elif there_exists(["where am i","where am I"],query):
                Ip_info = requests.get('https://api.ipdata.co?api-key=7457b2c9b86b5c313411127872d9f103ee19a7807e831a68f83398fc').json()
                loc = Ip_info['city']
                SR.speak(f"You must be somewhere in {loc}")
            elif there_exists(["my ip address","what is my ip address"],query):
                Ip_info = requests.get('https://api64.ipify.org?format=json').json()
                loc = Ip_info['ip']
                SR.speak(f"Your IP Address is: {loc}")     
            ...
            #flipping coin
            elif there_exists(["toss a coin","flip a coin","toss","Toss a Coin"],query):
                moves=["head", "tails"]
            ...
            #opening software applications
            ...
            elif there_exists(['open ubuntu','start terminal','open terminal'],query):
                SR.speak('Opening ubuntu')
                os.startfile(r'C:\Program Files\WindowsApps\CanonicalGroupLimited.Ubuntu22.04LTS_2204.2.37.0_x64__79rhkp1fndgsc\ubuntu2204.exe')    
                
                break
            elif there_exists(['open calculator','open calc','open calsy'],query):
                ...
                os.startfile('"C:\Program Files\WindowsApps\Microsoft.Paint_11.2208.6.0_x64__8wekyb3d8bbwe\PaintApp\mspaint.exe"')
                break
                ...
                os.startfile("C:\Program Files\WindowsApps\Microsoft.ScreenSketch_11.2209.2.0_x64__8wekyb3d8bbwe\ScreenSketch.exe")
                break
            elif there_exists(['open code','open visual studio ','open vs code'],query):
                SR.speak("Opening vs code")
                codepath=r"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Visual Studio Code\Visual Studio Code.lnk"
                ...
                break
            elif there_exists(['powershell','power cell'],query):
                ...
                os.startfile(r'C:\Users\Madavaraj K\OneDrive\Desktop\WhatsApp.lnk')
                break
            ...
            #weather report
            elif there_exists(['weather report','temperature','weather now','weather'],query):
